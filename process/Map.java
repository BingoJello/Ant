...
/**
 * This class allows the storage of the elements who are in the simulation.
 * 
 * @author Nubian
 *
 */
public class Map {
	...
	/**
	 * This method gives the possibility of add Obstackes to the map.
	 * 
	 * @return void 
	 */
	...
	public void removeDeadAnt(int indiceAnt,Ant ant) {
		...
		if(ants.get(indiceAnt).getTypeOfDead().equals(" ")){
			ants.get(indiceAnt).setTypeOfDead(" And i have died of natural causes.");
		}
		...
		this.mapCharacteristics.incrementationDeathToll();
	...
	public void mapUpdate() {
		...
		int deathTool=this.getCimiteryAnt().size();
		this.mapCharacteristics.setDeathToll(deathTool);
	}
