...
public class MapCharacteristics {
	...
	/**
	 * This class is used the storage of fundamental information for the course of the simulation.
	 * This class uses Singleton design pattern to maintain the consistency on values.
	 * 
	...
	public void incrementationDeathToll() {
		this.deathToll++;
	}
